                  ...
                  <div className="w-full lg:w-1/2 px-4 py-2">
                    <details className="mb-4">
                      ...
                      <span className="px-4 py-2">
                        Context API is a fairly new concept in the world of
                        React. It is designed to share data that can be
                        considered global for a tree of React components.
                        Context API is primarily used when some data needs to be
                        accessible by many components at different nesting
                        levels. So, When we want to share data between
                        components without using props or actions, we use
                        context API. Because Context API can significantly
                        reduce the complexity of state management in
                        application.
                      </span>
                    </details>
                    <details className="mb-4">
                      ...
                      <span className="px-4 py-2">
                        ...
                        JavaScript functions. It allows you to reuse some piece
                        of code in several parts of your app. We can create the
                        custom hook same way as we create any JS function. Look
                        at it as a refactoring of code into another function to
                        make it reusable. It will speed up productivity and save
                        our time.
                      </span>
                    </details>
                  </div>
                  <div className="w-full lg:w-1/2 px-4 py-2">
                    <details className="mb-4">
                      ...
                      <span className="px-4 py-2">
                        ...
                        <br /> <code>useRef</code> hook syntax is: <br />{" "}
                    ...
                    <details className="mb-4">
                      ...
                      <span className="px-4 py-2">
                        ...
                        of react that returns a memoized value. In Computer
                        Science, memoization is a concept used in general when
                        we don’t need to recompute the function with a given
                        argument for the next time as it returns the cached
                        result. A memoized function remembers the results of
